          ...
          <div class="col-md-8 order-md-1">
            ...
            <form class="needs-validation" novalidate="">
              ...
              <div class="mb-3"> <label for="username">Background 背景</label>
                <div class="input-group">
                  <b-form-textarea id="textarea1" v-model="background" placeholder="Enter something" :rows="3" :max-rows="6">
                  </b-form-textarea>
                  <div class="invalid-feedback" style="width: 100%;"> Your username is required. </div>
                </div>
              </div>
              ...
              <div class="mb-3"> <label for="username">Introduction 简介</label>
                <div class="input-group">
                  <b-form-textarea id="textarea1" v-model="introduction" placeholder="Enter something" :rows="3" :max-rows="6">
                  </b-form-textarea>
                  <div class="invalid-feedback" style="width: 100%;"> Your username is required. </div>
                </div>
              </div>
              ...
              <div class="mb-3"> <label for="username">Abilities Required 能力要求</label>
                <div class="input-group">
                  <b-form-textarea id="textarea1" v-model="abilities" placeholder="Enter something" :rows="3" :max-rows="6">
                  </b-form-textarea>
                  <div class="invalid-feedback" style="width: 100%;"> Your username is required. </div>
                </div>
              </div>
              ...
              <div class="mb-3"> <label for="username">Detailed Description 详细说明</label>
                <div class="input-group">
                  <b-form-textarea id="textarea1" v-model="detailed" placeholder="Enter something" :rows="3" :max-rows="6">
                  </b-form-textarea>
                  <div class="invalid-feedback" style="width: 100%;"> Your username is required. </div>
                </div>
              </div>
  ...
  methods: {
    ...
    save() {
      ...
      console.log({
        ...
        abilities: that.abilities,
        detailed: that.detailed,
        number: that.number,
        deadline: that.deadline
      });
      $.get("/assignmentForm/save", {
        title: that.title,
        background: that.background,
        introduction: that.introduction,
        keywords: that.keywords,
    ...
    getInfo() {
      ...
      if (!this.$route.query.isNew) {
        $.get("/assignmentForm/get", {}).then(function(data) {
