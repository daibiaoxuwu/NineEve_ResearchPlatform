            ...
            <form class="needs-validation" novalidate="">
              ...
              <div class="row">
                <div class="col-md-12 mb-3"> <label for="email">Research Area 实验室方向</label>
                  <b-form-textarea id="textarea1" v-model="researchArea" placeholder="Enter something" :rows="3" :max-rows="6">
                  </b-form-textarea>
                  <div class="invalid-feedback"> Please enter a valid email address for shipping updates. </div>
                </div>
                <div class="col-md-12 mb-3"> <label for="email">Research Results 科研成果介绍</label>
                  <b-form-textarea id="textarea1" v-model="researchResults" placeholder="Enter something" :rows="3" :max-rows="6">
                  </b-form-textarea>
                  <div class="invalid-feedback"> Please enter a valid email address for shipping updates. </div>
                </div>
...
export default {
  ...
  data() {
    return {
      lab: -1,
      dropdownText: "Please Select 请选择",
      lastName: "",
      firstName: "",
      username: "",
      wechatPhone: "",
  ...
  methods: {
    ...
    save() {
      ...
      console.log({
        ...
        researchArea: that.researchArea,
        researchResults: that.researchResults,
        lab: that.lab
      });
    ...
    getInfo() {
      var that = this;
      $.get("/teacherInfo/get", {}).then(function(data) {
    ...
    launch() {
      ...
      if (
        ...
        that.researchArea.length > 2000 ||
        that.researchResults.length > 2000
      ) {
