...
<div class="row">
        <div class="col-md-12">
          <div class="btn-group col-md-12" >
            <a href="#" class="btn btn-outline-primary btn-lg btn-block" style="marginTop:0.5rem;">Btn 1</a>
            <a href="#" class="btn btn-outline-primary btn-lg btn-block">Btn 2</a>
            <a href="#" class="btn btn-outline-primary btn-lg btn-block">Btn 3</a>
          </div>
        </div>
      </div>
                  <!-- <hr class="mb-4"> -->
...
请确认了解不同构建版本并在你发布的站点中使用生产环境版本，把 vue.js 换成 vue.min.js。这是一个更小的构建，可以带来比开发环境下更快的速度体验。
 ...
 <p class="form-text" style="font-weight:bold;">截至时间</p>
         <p class="form-text text-muted">
         2018-10-3
</p>
